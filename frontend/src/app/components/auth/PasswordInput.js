...
export default function PasswordInput({ value, onChange, placeholder = "Password", error }) {
  ...
  const baseClass = "w-full bg-transparent border rounded-xl px-4 py-3 text-[14px] text-black outline-none focus:bg-white focus:text-black transition-all placeholder:text-black pr-11"
