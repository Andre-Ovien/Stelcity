...
export default function RawMaterialClient({ params }) {
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-24 md:pb-10 max-w-5xl mx-auto xl:mt-7">
        <div className="md:flex md:gap-8 md:items-start">
          ...
          <div className="md:flex-1">
            ...
            <p className="text-[16px] md:text-[20px] font-semibold text-[#D65A5A] mt-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.variants.map((v) => (
                    <button
                      ...
                      className={`px-4 py-1.5 rounded-full border text-[13px] font-medium transition-all active:scale-95 ${
